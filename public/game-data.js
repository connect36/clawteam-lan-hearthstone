...
export const mechanicTestCards = Object.freeze([
  ...
  {
    id: 'mt-frenzy', name: '暴怒测试', cost: 3, type: 'minion', attack: 3, health: 4, deckCount: 2,
    text: '暴怒：获得+2攻击力。',
    mechanics: ['frenzy'],
    effects: [],
  ...
  {
    id: 'mt-spellburst', name: '法术迸发测试', cost: 2, type: 'minion', attack: 2, health: 3, deckCount: 2,
    text: '法术迸发：抽1张牌。',
  ...
  {
    id: 'mt-honorablekill-minion', name: '荣誉消灭测试(随从)', cost: 4, type: 'minion', attack: 3, health: 3, deckCount: 2,
    text: '荣誉消灭：抽1张牌。',
  ...
  {
    id: 'mt-honorablekill-spell', name: '荣誉消灭测试(法术)', cost: 3, type: 'spell', deckCount: 2,
    text: '造成3点伤害。荣誉消灭：召唤一个2/2随从。',
    mechanics: ['honorableKill'],
    effects: [{ type: 'damage', target: 'playerChoice', targetKinds: ['minion'], amount: 3 }],
    bonusMechanicEffects: { honorableKill: [{ type: 'summon', target: 'friendlyBoard', amount: 1, minion: { name: '荣誉卫士', attack: 2, health: 2 } }] },
  },
  {
    id: 'mt-poke', name: '轻戳测试', cost: 0, type: 'spell', deckCount: 2,
    text: '对一个友方随从造成1点伤害。',
    mechanics: [],
    effects: [{ type: 'damage', target: 'friendlyMinion', amount: 1 }],
  },
  {
    id: 'mt-heal', name: '治疗测试', cost: 0, type: 'spell', deckCount: 2,
    text: '为一个友方随从恢复3点生命值。',
    mechanics: [],
    effects: [{ type: 'heal', target: 'friendlyMinion', amount: 3 }],
  },
  {
    id: 'mt-overheal', name: '过量治疗测试', cost: 3, type: 'minion', attack: 2, health: 5, deckCount: 2,
    text: '过量治疗：抽1张牌。',
    mechanics: ['overheal'],
    effects: [],
  ...
  {
    id: 'mt-corrupt', name: '腐蚀测试', cost: 2, type: 'minion', attack: 2, health: 2, deckCount: 2,
    text: '腐蚀：获得+3/+3。',
    mechanics: ['corrupt'],
    effects: [],
...
export const mechanicTestDeck = [
  ...
  { cardId: 'mt-frenzy', count: 2 },
  { cardId: 'mt-poke', count: 2 },
  { cardId: 'mt-heal', count: 2 },
  { cardId: 'mt-spellburst', count: 2 },
  { cardId: 'mt-honorablekill-minion', count: 2 },
